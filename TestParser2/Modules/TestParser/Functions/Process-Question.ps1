function Process-Question {
	...
	write-host -backgroundcolor "yellow" -foregroundcolor "blue" "Process-Question is no longer a valid cmdlet and is slated to be removed.  Please send email to Brion.lang@comtechtel when you see this message or update to latest TestParser2.ps1 code."
