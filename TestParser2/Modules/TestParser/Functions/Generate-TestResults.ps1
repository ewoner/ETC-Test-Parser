function Generate-TestResults {
	...
	write-host -backgroundcolor "yellow" -foregroundcolor "blue" "Generate-TestResults is no longer a valid cmdlet and is slated to be removed.  Please send email to Brion.lang@comtechtel when you see this message or update to latest TestParser2.ps1 code."
